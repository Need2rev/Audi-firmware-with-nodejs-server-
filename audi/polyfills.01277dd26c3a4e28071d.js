  ...
  [98],
  {
    ...
    GmLw: function (t, e, n) {
      ...
      function c(t, e, n) {
        ...
        if (N(t, ArrayBuffer) || (t && N(t.buffer, ArrayBuffer)))
          return h(t, e, n);
        if (
        ...
        var o = (function (t) {
          ...
          return void 0 !== t.length
            ? "number" != typeof t.length || U(t.length)
              ? s(0)
              : f(t)
      ...
      ((e.Buffer = a),
        ...
        (a.concat = function (t, e) {
          ...
          for (n = 0; n < t.length; ++n) {
            var i = t[n];
            if ((N(i, Uint8Array) && (i = a.from(i)), !a.isBuffer(i)))
              throw new TypeError(
    ...
    "hN/g": function (t, e, n) {
      ...
      (n.r(e),
        n("nf2o"),
        (window.Buffer = n("GmLw").Buffer),
        (window.process = n("F63i")),
        ...
        (o =
          ...
          typeof (r = function () {
            ...
            (!(function (t) {
              ...
              class a {
                ...
                runTask(t, e, n) {
                  ...
                  if (t.state === w && (t.type === O || t.type === C)) return;
                  const r = t.state != T;
                  (r && t._transitionTo(T, _), t.runCount++);
                  const o = I;
                  ((I = t), (D = { parent: D, zone: this }));
                  try {
                    t.type == C &&
                      t.data &&
                      !t.data.isPeriodic &&
                    ...
                    (t.state !== w &&
                      ...
                      (t.type == O || (t.data && t.data.isPeriodic)
                        ? r && t._transitionTo(_, T)
                        : ((t.runCount = 0),
                          this._updateTaskCount(t, -1),
                          r && t._transitionTo(w, T, w))),
                      (D = D.parent),
                      (I = o));
                  }
                }
                ...
                scheduleMicroTask(t, e, n, r) {
                  return this.scheduleTask(new l(Z, t, e, n, r, void 0));
                }
              ...
              class l {
                ...
                _transitionTo(t, e, n) {
                  if (this._state !== e && this._state !== n)
                    throw new Error(
                      `${this.type} '${this.source}': can not transition to '${t}', expecting state '${e}'${n ? " or '" + n + "'" : ""}, was '${this._state}'.`,
                    );
            ...
            function T(n, r, o) {
              ...
              (f || (f = k[u] = l("ON_PROPERTY" + u)),
                (i.set = function (t) {
                  ...
                  (e || n !== p || (e = p),
                    e &&
                      (e[f] && e.removeEventListener(u, _),
                      c && c.apply(e, d),
                      "function" == typeof t
                        ? ((e[f] = t), e.addEventListener(u, _, !1))
                        : (e[f] = null)));
                }),
                (i.get = function () {
                  let t = this;
            ...
            function Z(t) {
              ...
              for (o in n)
                "prototype" !== o && n.hasOwnProperty(o) && (p[t][o] = n[o]);
            }
            function C(e, r, o) {
              let i = e;
            ...
            const L = { useG: !0 },
              j = {},
              R = {},
              x = new RegExp("^" + a + "(\\w+)(true|false)$"),
              M = l("propagationStopped");
            function N(t, e) {
              const n = (e ? e(t) : t) + "false",
                r = (e ? e(t) : t) + "true",
                o = a + n,
                i = a + r;
              ((j[t] = {}), (j[t].false = o), (j[t].true = i));
            }
            function U(t, e, r) {
                ...
                p = function (e) {
                  ...
                  if (r)
                    if (1 === r.length) h(r[0], n, e);
                      ...
                      const t = r.slice();
                      for (let r = 0; r < t.length && (!e || !0 !== e[M]); r++)
                        h(t[r], n, e);
                    }
                },
                d = function (e) {
              ...
              function g(e, r) {
                ...
                let b = e;
                for (; b && !b.hasOwnProperty(o); ) b = n(b);
                ...
                r && r.prepend && (Z = b[l(r.prepend)] = b[r.prepend]);
                const O = h
                    ? function (t) {
                        if (!k.isExisting)
                          return _.call(
                  ...
                  I = Zone[l("BLACK_LISTED_EVENTS")],
                  z = t[l("PASSIVE_EVENTS")],
                  M = function (e, n, o, i, s = !1, a = !1) {
                    return function () {
                      const c = this || t;
                      let u = arguments[0];
                      ...
                      const m = !!d && ("boolean" == typeof d || d.capture),
                        b = !(!d || "object" != typeof d) && d.once,
                        _ = Zone.current;
                      let T = j[u];
                      T || (N(u, w), (T = j[u]));
                      const E = T[m ? "true" : "false"];
                      let S,
                        Z = c[E],
                        O = !1;
                      if (Z) {
                      ...
                      const x = h ? L : void 0;
                      x && (x.taskData = k);
                      const M = _.scheduleEventTask(S, l, x, o, i);
                      return (
                        (k.target = null),
                        x && (x.taskData = null),
                        b && (d.once = !0),
                        (B || "boolean" != typeof M.options) && (M.options = d),
                        (M.target = c),
                        (M.capture = m),
                        (M.eventName = u),
                        f && (M.originalDelegate = l),
                        a ? Z.unshift(M) : Z.push(M),
                        s ? c : void 0
                      );
                    };
                  };
            ...
            function rt(t, e) {
              ...
              i && nt(i.prototype, Y, o);
              const s = e.XMLHttpRequestEventTarget;
              (s && nt(s && s.prototype, Y, o),
                        ...
                        function (t, n) {
                          ...
                          if (t[r]) return _.apply(t, n);
                          {
                            const e = {
                              ...
                              r = u("XMLHttpRequest.send", m, e, y, v);
                            t &&
                              !0 === t[f] &&
                              !e.aborted &&
                              "scheduled" === r.state &&
                        ...
                        function (t, r) {
                          ...
                          if (o && "string" == typeof o.type) {
                            if (
                              ...
                              return;
                            o.zone.cancelTask(o);
                          } else if (!0 === e.current[w]) return T.apply(t, r);
                        },
                    );
                })(t);
                const n = l("xhrTask"),
