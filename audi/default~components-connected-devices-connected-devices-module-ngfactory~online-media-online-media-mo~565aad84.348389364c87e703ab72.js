(window.webpackJsonp = window.webpackJsonp || []).push([
  [27],
  {
      ...
      t.exports = (function () {
        ...
        ((t.prototype = {
          ...
          (e.prototype = {
            ...
            createMovieClip: function (t, e, r) {
              ...
              for (var o = 0; o < this.modules.length; o++)
                for (var n = 1 * o, a = 0; a < this.modules[o].length; a++) {
                  var s = 1 * a;
                  this.modules[o][a] &&
                    (i.beginFill(0, 100),
                    i.moveTo(s, n),
            ...
            setupPositionAdjustPattern: function () {
              for (
                var t = n.getPatternPosition(this.typeNumber), e = 0;
                e < t.length;
                e++
              )
            ...
            setupTypeNumber: function (t) {
              for (
                var e = n.getBCHTypeNumber(this.typeNumber), r = 0;
                r < 18;
                r++
              ) {
                var i = !t && 1 == ((e >> r) & 1);
            ...
            setupTypeInfo: function (t, e) {
              for (
                var r = n.getBCHTypeInfo((this.errorCorrectLevel << 3) | e),
                  i = 0;
                i < 15;
                i++
              ) {
            ...
            mapData: function (t, e) {
              for (
                ...
                for (6 == s && s--; ; ) {
                  for (var h = 0; h < 2; h++)
                    if (null == this.modules[i][s - h]) {
                      var l = !1;
                      (a < t.length && (l = 1 == ((t[a] >>> o) & 1)),
                        n.getMask(e, i, s - h) && (l = !l),
                        (this.modules[i][s - h] = l),
                        -1 == --o && (a++, (o = 7)));
                    }
          ...
          (e.createData = function (t, r, i) {
            for (
              var o = l.getRSBlocks(t, r), a = new u(), s = 0;
              s < i.length;
              s++
            ) {
              var h = i[s];
              (a.put(h.mode, 4),
                a.put(h.getLength(), n.getLengthInBits(h.mode, t)),
                h.write(a));
            }
            var f = 0;
            ...
            for (
              a.getLengthInBits() + 4 <= 8 * f && a.put(0, 4);
            ...
            for (
              ...
              !(
                ...
                (a.put(e.PAD0, 8), a.getLengthInBits() >= 8 * f)
              );
          ...
          (e.createBytes = function (t, e) {
            for (
              ...
              for (var g = 0; g < a[l].length; g++)
                a[l][g] = 255 & t.buffer[g + r];
              r += u;
              var c = n.getErrorCorrectPolynomial(f),
                d = new h(a[l], c.getLength() - 1).mod(c);
              for (
                s[l] = new Array(c.getLength() - 1), g = 0;
                g < s[l].length;
                g++
              ) {
            ...
            for (g = 0; g < i; g++)
              for (l = 0; l < e.length; l++)
                g < a[l].length && (v[_++] = a[l][g]);
            for (g = 0; g < o; g++)
              for (l = 0; l < e.length; l++)
                g < s[l].length && (v[_++] = s[l][g]);
            return v;
          }));
        for (
          var r = {
            ...
            n = {
              ...
              getBCHTypeInfo: function (t) {
                for (
                  var e = t << 10;
                  n.getBCHDigit(e) - n.getBCHDigit(n.G15) >= 0;

                )
                  e ^= n.G15 << (n.getBCHDigit(e) - n.getBCHDigit(n.G15));
                return ((t << 10) | e) ^ n.G15_MASK;
              },
              getBCHTypeNumber: function (t) {
                for (
                  var e = t << 12;
                  n.getBCHDigit(e) - n.getBCHDigit(n.G18) >= 0;

                )
                  e ^= n.G18 << (n.getBCHDigit(e) - n.getBCHDigit(n.G18));
                return (t << 12) | e;
              },
              ...
              getErrorCorrectPolynomial: function (t) {
                for (var e = new h([1], 0), r = 0; r < t; r++)
                  e = e.multiply(new h([1, a.gexp(r)], 0));
                return e;
              },
              ...
              getLostPoint: function (t) {
                for (var e = t.getModuleCount(), r = 0, i = 0; i < e; i++)
                  for (var o = 0; o < e; o++) {
                    for (var n = 0, a = t.isDark(i, o), s = -1; s <= 1; s++)
                      if (!(i + s < 0 || e <= i + s))
                        for (var h = -1; h <= 1; h++)
                          o + h < 0 ||
                            e <= o + h ||
                            (0 == s && 0 == h) ||
                            (a == t.isDark(i + s, o + h) && n++);
                    n > 5 && (r += 3 + n - 5);
                  }
                for (i = 0; i < e - 1; i++)
                  for (o = 0; o < e - 1; o++) {
        ...
        ((h.prototype = {
          ...
          multiply: function (t) {
            for (
              ...
              for (var i = 0; i < t.getLength(); i++)
                e[r + i] ^= a.gexp(a.glog(this.get(r)) + a.glog(t.get(i)));
            return new h(e, 0);
          },
          mod: function (t) {
          ...
          (l.getRSBlocks = function (t, e) {
            ...
            for (var i = r.length / 3, o = [], n = 0; n < i; n++)
              for (
                var a = r[3 * n + 0], s = r[3 * n + 1], h = r[3 * n + 2], u = 0;
                u < a;
                u++
              )
                o.push(new l(s, h));
          ...
          ((i = function (t, e) {
            ...
            ((this._oQRCode = new e(
              (function (t, e) {
                ...
                if (r > f.length) throw new Error("Too long data");
                return r;
        ...
        o = (function () {
          function t(t) {
            ...
            ((this.el = t),
              ...
              (this.size = 256),
              (this.usesvg = !1),
              (this.isValidQrCodeText = function (t) {
                return !1 === e.allowEmptyString
                  ? !(void 0 === t || "" === t)
                  : !(void 0 === t);
              }));
          }
          return (
            (t.prototype.ngOnInit = function () {
              try {
                ...
                this.qrcode = new i(this.el.nativeElement, {
                  colorDark: this.colordark,
                  colorLight: this.colorlight,
                  correctLevel: i.CorrectLevel[this.level.toString()],
                  height: this.size,
                  text: this.qrdata || " ",
                  useSVG: this.usesvg,
                  width: this.size,
                ...
                console.error("Error generating QR Code: " + t.message);
              }
            }),
            (t.prototype.ngOnChanges = function (t) {
              if (this.qrcode) {
                var e = t.qrdata;
                e &&
                  this.isValidQrCodeText(e.currentValue) &&
                  (this.qrcode.clear(), this.qrcode.makeCode(e.currentValue));
              }
            }),
            t
          );
    ...
    ywFE: function (t, e, r) {
      ...
      var i = r("kZht"),
        o = (r("yn/i"), i.wb({ encapsulation: 2, styles: [], data: {} }));
      function n(t) {
        return i.ac(2, [], null, null);
      }
    },
  },
]);
